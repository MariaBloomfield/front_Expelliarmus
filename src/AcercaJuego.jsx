...
export default function AcercaJuego() {
    return(
        ...
        <tr>
            <td>1</td>
            <td> <img class="image-cell" src="/assets/imgs/avatars/harry.jpeg" alt="" title="Harry"/></td>
            <td>Maria Anders</td>
            <td>Griffindor</td>
            <td>1057</td>
        </tr>
        <tr>
            <td>2</td>
            <td> <img class="image-cell" src="/assets/imgs/avatars/cedric.jpeg" alt="" title="Harry"/></td>
        ...
        <tr>
            <td>3</td>
            <td> <img class="image-cell" src="/assets/imgs/avatars/luna.jpeg" alt="" title="Harry"/></td>
        ...
        <tr>
            <td>4</td>
            <td> <img class="image-cell" src="/assets/imgs/avatars/draco.jpeg" alt="" title="Harry"/></td>
            <td>Roland Mendel</td>
            <td>Slytherin</td>
            <td>808</td>
        </tr>
        <tr>
            <td>5</td>
            <td> <img class="image-cell" src="/assets/imgs/avatars/hermaione.jpeg" alt="" title="Harry"/></td>
            <td>Helen Bennett</td>
            <td>Griffindor</td>
            <td>779</td>
        </tr>
